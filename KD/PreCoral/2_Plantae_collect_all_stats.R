...
species_types=c("Plantae_CR", "Plantae_EN", "Plantae_LC")
...
a
ggsave(a, file="results2/proportion_of_Plantae_under_multiple_threats.tiff", width=6, height=4)
...
a=ggplot(all_tables, aes(x=proj_name, y=single_prop, fill=species_type)) +   
  geom_bar(aes(fill = species_type), position = "dodge", stat="identity")
a
ggsave(a, file="results2/proportion_of_Plantae_under_single_threat.tiff", width=6, height=4)
...
a
ggsave(a, file="results2/mean.n.Plantae_threats.nonZero.tiff", width=6, height=4)
...
a
ggsave(a, file="results2/mean.n.Plantae_threats.nonZero.with.error.tiff", width=6, height=4)
