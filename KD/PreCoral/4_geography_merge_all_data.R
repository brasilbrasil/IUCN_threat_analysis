...
levels(all_data_combined[,"Geography"])=c(levels(all_data_combined[,"Geography"]),"multi")
all_data_combined[jnk2,"Geography"]="multi"

all_data_combined_wThreat=all_data_combined[all_data_combined$n_threats>0,]

write.table(all_data_combined, file = paste0("results/all_data_combined",".csv"), sep=",", row.names = FALSE)
write.table(all_data_combined_wThreat, file = paste0("results/all_data_combined_onlySppWThreatInfo",".csv"), sep=",", row.names = FALSE)