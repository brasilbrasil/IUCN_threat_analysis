...
for (species_type in species_types){
  threat_matrix = read.csv(paste0("NEW_matrix/","threat_matrix_rem_",species_type,".csv"), header = T, row.names = NULL, check.names = FALSE) #
  ...
  threat_summary_fx=function(threat_matrix_summary, proj_name){
    jpeg_name = paste0("resultsNEW/", proj_name, "_histogram_of_number_of_threats_",species_type,"_species.jpg") #names jpeg file to be created
    ...
    name = paste0("resultsNEW/", proj_name, "_threat_count_distr_",species_type,"_species.csv") #names jpeg file to be created
