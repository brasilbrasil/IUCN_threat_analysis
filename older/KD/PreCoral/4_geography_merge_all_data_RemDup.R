...
write.table(all_data_combined, file = paste0("resultsGEO2/all_data_combined",".csv"), sep=",", row.names = FALSE)
write.table(all_data_combined_wThreat, file = paste0("resultsGEO2/all_data_combined_onlySppWThreatInfo",".csv"), sep=",", row.names = FALSE)
